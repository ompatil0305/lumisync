...
BUILDING_NUMBER_MAPPING = {
    'holden-hall': '0001',
    'admin-building': '0002',
    'university-library': '0132',
    'sub': '0134',
    'rawls-college': '0097',
    'jones-stadium': '0060',
    'student-rec': '0138',
    ...
    'chemistry': '0011',
    'biology': '0009',
    'talkington-hall': '0142',
    'moody-planetarium': '0085'
}
...
def migrate():
    ...
    with engine.connect() as conn:
        for osm_b in campus_data:
            ...
            # Get building number from mapping or OSM, fallback to N/A
            official_num = BUILDING_NUMBER_MAPPING.get(unique_id) or BUILDING_NUMBER_MAPPING.get(target_id) or osm_b.get("officialNumber") or 'N/A'
            if official_num == 'N/A':
            ...
            if "Greenhouse" in name or "Greenhouse" in unique_id:
                needs_verification = True
                official_num = 'N/A'

            # Realistic Hours based on category or specific building
            hours = {}
            if unique_id == 'university-library' or target_id == 'university-library':
                hours = {
                    "Mon-Thu": "24 Hours",
                    "Fri": "Close at 10:00 PM",
                    "Sat": "10:00 AM - 10:00 PM",
                    "Sun": "Open at 10:00 AM"
                }
            elif category == 'dining':
                if 'stangel' in unique_id or 'murdough' in unique_id:
                    hours = {
                        "Mon-Fri": "7:00 AM - 10:00 PM",
                        "Sat-Sun": "9:00 AM - 10:00 PM"
                    }
                elif 'sub' in unique_id:
                    hours = {
